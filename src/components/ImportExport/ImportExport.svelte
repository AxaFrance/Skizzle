...
<p class="intro">
	Skizzle permet d'importer et d'exporter une liste de repositories suivis. Vous
	pouvez partager votre liste avec les autres membres de votre équipe.
</p>
<Tabs
	onChange={changeTab}
	current={currentTab}
...
<div class="container">
	...
	{:else}
		<form on:submit|preventDefault={importCode}>
			<p class="intro">
				Collez le code JSON provenant d'une autre instance de Skizzle. <b>
					Attention
				</b>
				 Skizzle remplacera les repositories que vous suivez actuellement.
			</p>
